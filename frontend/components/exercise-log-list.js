  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4">
        {logs.map((log) => (
          <div key={log.id} className="soft-card rounded-[24px] p-5">
    ...
    return (
      <div className="soft-card rounded-[28px] p-6">
        <p className="text-sm text-slate-500">
          {t(lang, "仍未有運動紀錄。新增手動運動，或同步 Apple Health 後會出現在這裡。", "No workout records yet. Add a manual workout or sync Apple Health to see activity here.")}
        </p>
      </div>
    );
  }
